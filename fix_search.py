...
clean = r"""import React, { useState, useEffect } from 'react';
  ...
  return (
    <div className="search-screen">
      <div className="search-header">
        ...
        <div className="powered-badge">Powered by AI &middot; Live &amp; Historical Data</div>
      </div>

      <form className="search-form" onSubmit={handleSubmit}>
        <div className="form-group">
          <label className="form-label">Stock Ticker / Company</label>
          <input
            type="text"
